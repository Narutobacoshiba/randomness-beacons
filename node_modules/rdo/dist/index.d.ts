declare type supportedBases = 2 | 8 | 10 | 16;
interface DrawData {
    /**
...
export default class Rdo {
    ...
    */
    private readonly isAuthed;
    /**
     * If authenticated via credentials.
    */
    private readonly hasCreds;
    constructor(conf?: {
        /**
    ...
    */
    integer({ min, max, amount, unique, base, }: {
        /**
    ...
    */
    sequence({ min, max, amount, length, unique, base, }: {
        /**
    ...
    */
    gaussian({ amount, mean, standardDeviation, significantDigits, }: {
        /**
    ...
    */
    string({ amount, length, characters, unique, }?: {
        /**
    ...
    */
    readonly draw: {
        ...
        */
        hold: ({ title, recordType, entries, winnerCount, entryType, identicalEntriesPermitted, winnerStart, winnerHandling, showEntries, showWinners, delegationKey, }: {
            /**
            ...
            */
            winnerHandling?: "replace" | "remove" | "exclude";
            /**
            ...
            */
             ...
             * Possible values are completed, withheld and test. The value indicates the status of the drawing. If there was sufficient credit in the client's account, the status will be completed. It may be withheld if insufficient credit was available in the client's account in which the account must be topped up for the result to be revealed. For drawings of type test, this value is test.
            */
            status: "completed" | "test" | "withheld";
            /**
             * The number of entries counted by RANDOM.ORG.
            */
            entryCount: number;
        ...
        */
        get: ({ drawID, maxEntries, delegationKey, }: {
            /**
    ...
    */
    readonly giveaway: {
        ...
        */
        begin: ({ description, entries, rounds, delegationKey, }: {
            /**
        ...
        */
        cont: ({ giveawayKey, delegationKey, }: {
            /**
    ...
    */
    readonly delegation: {
        ...
        */
        add({ serviceID, delegateID, notifyDelegate, }: {
            /**
        ...
        */
        remove({ delegationKey, notifyDelegate, }: {
            /**
             * UUID identifying this delegation.
            */
            delegationKey: string;
